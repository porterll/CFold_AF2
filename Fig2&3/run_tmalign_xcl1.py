...
def main():
    ...
    for pdb in pdb_structures:
        ...
        print(names)
        # calculate tmscore
        t1_sub = tmscore(f"{names[0]} & i. 1-65",f"{names[2]} & i. 1-65", quiet=1, exe='/Users/schaferjw/pymol_setup/TMalign')
        ...
        t2_sub = tmscore(f"{names[1]} & i. 1-65",f"{names[2]} & i. 1-65", quiet=1, exe='/Users/schaferjw/pymol_setup/TMalign')
        ...
        #calculate rmsd
        rmsd1 = pymol.cmd.align(f"{names[0]} & i. 1-65",f"{names[2]} & i. 1-65")
        ...
        rmsd2 = pymol.cmd.align(f"{names[1]} & i. 1-65",f"{names[2]} & i. 1-65")
        ...
        data["bfactor"].append(np.average(np.array(bf)[:66]))
